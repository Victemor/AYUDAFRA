...
public class FragmentAction
{
    ...
    [TextArea]
    [Tooltip("Texto libre usado por acciones legacy o de pensamiento.")]
    ...
    /// <summary>
    /// Desplazamiento vertical del panel de tutorial.
    /// Permite reposicionarlo para evitar que tape elementos de UI.
    /// </summary>
