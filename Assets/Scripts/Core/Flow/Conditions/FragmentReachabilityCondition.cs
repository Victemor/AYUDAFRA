...
{
    /// <summary>
    /// Evalúa si un conjunto de fragmentos pertenece al mismo subgrafo conectado
    /// por camino y si ese subgrafo contiene exclusivamente esos fragmentos.
    /// 
    /// El orden en que se declaren los fragmentos no afecta el resultado.
    /// Además, cada fragmento puede declarar cero o más requisitos de estado
    /// para objetos internos.
    /// </summary>
    [CreateAssetMenu(menuName = "Game/Conditions/Fragment Reachability")]
    public sealed class FragmentReachabilityCondition : Condition
    {
        ...
        public override bool Evaluate(RuntimeContext context)
        {
            ...
            bool result = context.Repository.AreMemoriesReachableExclusive(requiredMemories);
            Log(result);
            return result;
        }
        ...
        public override string GetDescription()
        {
            ...
            return $"Fragment Reachability Exclusive ({count})";
        }
